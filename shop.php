                                ...
                                <div class="col-md-9">
                                    <form method="post" class="subscribe-form">
                                        <div class="form-group d-flex">
                                            <input type="text" name="search-product" class="form-control"
            ...
            <div class="row">
                ...
                try {
                    ...
                    if (isset($_POST['search'])) {
                        ...
                        ORDER BY id DESC 
                        LIMIT " . $startAt . ", " . $total_no_per_page;
                        ...
                        <div class="col-sm col-md-6 col-lg-3 ftco-animate">
                            <div class="product">
                                ...
                                <div class="text py-3 px-3">
                                    <h3>
                                        <a
                                            href="product-details.php?product_id=<?php echo $row['id']; ?>"><?php echo $name; ?></a>
                                    </h3>
                                    <div class="d-flex">
                                        <div class="pricing">
                                            <p class="price">
