                                            ...
                                            foreach ($rows as $row) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center js-sweetalert">
                                                        <button data-toggle="modal" data-target="#infoModal_<?php echo $row['id']; ?>" class="btn btn-info btn-xs waves-effect">
                ...
                <form method="post" id="product_form" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-line">
                                <textarea rows="1" name="description" placeholder="Enter description" class="form-control no-resize auto-growth" style="overflow: hidden; overflow-wrap: break-word; height: 35px;" required></textarea>
                            </div>
                        </div>
                        <div class="form-group">
